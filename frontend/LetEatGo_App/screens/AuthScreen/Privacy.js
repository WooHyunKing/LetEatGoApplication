          ...
          <View style={{height: '62%', marginTop: 15}}>
            <ScrollView
              ...
              <Text style={{fontSize: 15, marginTop: 20}}>
                ...
                홈페이지 회원가입 및 관리 ) 필수항목 : 비밀번호, 로그인ID, 성별,
                서비스 이용 기록 선택항목 :
              </Text>
              ...
              <Text style={{fontSize: 15, marginTop: 20}}>
                ...
                '입맛춤' 은(는) 파기 사유가 발생한 개인정보를 선정하고, '입맛춤'
                의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다. 2.
              ...
              <Text style={{fontSize: 15, marginTop: 20}}>
                ② 제1항에 따른 권리 행사는('입맛춤 어플리케이션'이하 '입맛춤')에
              ...
              <Text style={{fontSize: 17, marginTop: 15}}>
                '입맛춤'은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를
                취하고 있습니다.
              </Text>
              ...
              <Text style={{fontSize: 15, marginTop: 20}}>
                ① '입맛춤'은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
              ...
              <Text style={{fontSize: 15, marginTop: 20}}>
                ▶ 개인정보 열람청구 접수·처리 부서 부서명 :렛잇고 담당자 :정윤미
                연락처 : 010-5135-8136
              </Text>
              ...
              {agree ? (
                <TouchableOpacity
                  ...
                  <Image
                    ...
                    source={require('../../android/app/assets/icons/Checked.png')}></Image>
                </TouchableOpacity>
              ) : (
                <TouchableOpacity
                  style={{marginRight: Width * 0.015}}
                  ...
                  <Image
                    style={{width: Width * 0.05, height: Width * 0.05}}
                    source={require('../../android/app/assets/icons/Check.png')}></Image>
                </TouchableOpacity>
              )}
